...
```bash
git clone https://github.com/VSRC-Arsenal/cookiemonster-burp-extender.git
cd cookiemonster/cmd/cookiemonster
go get; go build
```
...
### Added by m0nsieur:
Laravel, Express, Itsdangerous, JWT, Rack was supported resign now. 
